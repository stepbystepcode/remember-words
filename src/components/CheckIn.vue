			...
			>
				<div class="header row items-center justify-between q-px-md">
						...
						><span class="q-btn__wrapper col row q-anchor--skip"
							><span
								...
								><i aria-hidden="true" role="img" class="material-icons q-icon notranslate"
									...
									>
										<desc>
											Download more icon variants from https://tabler-icons.io/i/arrow-left
										</desc>
					...
					<button
						...
						type="button"
						role="button"
						class="q-btn q-btn-item non-selectable no-outline q-btn--standard q-btn--round bg-primary text-white q-btn--actionable q-focusable q-hoverable q-btn--wrap"
					>
						<span class="q-focus-helper"></span
						><span class="q-btn__wrapper col row q-anchor--skip"
							><span
...
.q-btn--push.q-btn--actionable .q-btn__wrapper:before {
	transition: top 0.3s cubic-bezier(0.25, 0.8, 0.5, 1), bottom 0.3s cubic-bezier(0.25, 0.8, 0.5, 1),
