    ...
    <div class="color-bg-list q-layout q-layout--standard">
      ...
      >
        <div class="header row items-center justify-between q-px-md">
          ...
          <div class="text-header color-text">一起背单词</div>
          <button
            tabindex="0"
            type="button"
            role="button"
          ...
          <div class="bg-content list-card color-bg-content">
            <div class="web-font q-card__section q-card__section--vert">
              <div class="row items-baseline">
                ...
                <div
                  class="list-category-text row items-center color-desc"
                  style="display: none"
                >
                  <i
                    aria-hidden="true"
                ...
                <div v-if="imgList[index] != ''">
                  ...
                  >
                    <a
                      ...
                      :key="i"
                      :href="`https://www.codingboy.xyz/upload/${img}`"
                    >
                      <img
                        class="list-image q-mr-sm"
                        alt="img1"
                        :src="`https://www.codingboy.xyz/upload/${img}`"
                      />
                    </a>
                  </lightgallery>
                </div>
      ...
      <div
        class="q-page-sticky row flex-center fixed-bottom q-page-sticky--expand"
        style="transform: translate(0px, 0px); margin: 42px 0px"
      >
        <button
        ...
        >
          ...
          ><span
            ...
            style="padding: 16px; min-width: 0px; min-height: 0px"
            ><span
              class="
                q-btn__content
                text-center
              ...
              ><i
                ...
                class="material-icons q-icon notranslate"
                style="width:10px;height:10px"
                ><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#fff" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 60.364 60.364" style="enable-background:new 0 0 60.364 60.364;" xml:space="preserve">
<g>
...
export default {
  ...
  methods: {
    moments(index, type) {
      let time = new Date(this.lists[index].time * 1000);
      switch (type) {
        case "Y":
